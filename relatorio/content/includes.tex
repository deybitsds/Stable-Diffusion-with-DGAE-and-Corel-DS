% Babel: intentar português, si no está disponible usar inglés
% Para instalar soporte português: sudo pacman -S texlive-lang
\usepackage[english]{babel}  % Cambiar a portuguese cuando se instale texlive-lang
...
% \usepackage{breakcites}  % Comentado: paquete no disponible, no es crítico
